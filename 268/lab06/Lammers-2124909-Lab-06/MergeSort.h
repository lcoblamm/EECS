...
public:
  /*
    @pre: None
    @post: MergeSort object and all its pointers are deleted
    @return: None
  */
  ~MergeSort();
  
  /*
    @pre: arr is array of valid T's, < operator is properly overloaded
      for T
...
private:
  ...
  */
  ...
  /*
    @pre: size is size of arr, size is at least 1
    @post: None
